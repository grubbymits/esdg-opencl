...
Value *CodeGenFunction::EmitTargetBuiltinExpr(unsigned BuiltinID,
  ...
  case llvm::Triple::le1:
    return EmitLE1BuiltinExpr(BuiltinID, E);
  default:
    return 0;
  }
}
...
Value *CodeGenFunction::EmitLE1BuiltinExpr(unsigned BuiltinID,
                                           const CallExpr *E) {
  SmallVector<Value*, 4> Ops;
  ...
  case LE1::BI__builtin_le1_read_local_idx:
    ...
    break;
  case LE1::BI__builtin_le1_read_local_idy:
    ID = Intrinsic::le1_read_local_idy;
    break;
  ...
  case LE1::BI__builtin_le1_read_global_size_0:
    ...
    break;
  case LE1::BI__builtin_le1_read_global_size_1:
    ID = Intrinsic::le1_read_global_size_1;
    break;
  case LE1::BI__builtin_le1_read_global_size_2:
    ID = Intrinsic::le1_read_global_size_2;
    break;
  case LE1::BI__builtin_le1_read_local_size_0:
    ID = Intrinsic::le1_read_local_size_0;
    break;
  case LE1::BI__builtin_le1_read_local_size_1:
    ID = Intrinsic::le1_read_local_size_1;
    break;
  ...
  case LE1::BI__builtin_le1_read_num_groups_0:
    ...
    break;
  case LE1::BI__builtin_le1_read_num_groups_1:
    ID = Intrinsic::le1_read_num_groups_1;
    break;
  case LE1::BI__builtin_le1_read_num_groups_2:
    ID = Intrinsic::le1_read_num_groups_2;
    break;
  case LE1::BI__builtin_le1_read_global_offset_0:
    ID = Intrinsic::le1_read_global_offset_0;
    break;
  case LE1::BI__builtin_le1_read_global_offset_1:
    ID = Intrinsic::le1_read_global_offset_1;
    break;
  ...
  case LE1::BI__builtin_le1_reset_local_idx:
    ...
    break;
  case LE1::BI__builtin_le1_reset_local_idy:
    ID = Intrinsic::le1_reset_local_idy;
    break;
  case LE1::BI__builtin_le1_reset_local_idz:
    ID = Intrinsic::le1_reset_local_idz;
    break;
  case LE1::BI__builtin_le1_inc_local_idx:
    ID = Intrinsic::le1_reset_local_idx;
    break;
  case LE1::BI__builtin_le1_inc_local_idy:
    ID = Intrinsic::le1_reset_local_idy;
    break;
  case LE1::BI__builtin_le1_inc_local_idz:
    ID = Intrinsic::le1_reset_local_idz;
    break;
  case LE1::BI__builtin_le1_read_global_idx:
    ID = Intrinsic::le1_read_global_idx;
    break;
  case LE1::BI__builtin_le1_read_global_idy:
    ID = Intrinsic::le1_read_global_idy;
    break;
