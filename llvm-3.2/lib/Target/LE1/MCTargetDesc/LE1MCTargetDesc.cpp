...
static MCAsmInfo *createLE1MCAsmInfo(const Target &T, StringRef TT) {
  MCAsmInfo *MAI = new LE1MCAsmInfo(T, TT);
...
extern "C" void LLVMInitializeLE1TargetMC() {
  ...
  //RegisterMCAsmInfoFn Y(TheLE1elTarget, createLE1MCAsmInfo);
  //RegisterMCAsmInfoFn A(TheLE164Target, createLE1MCAsmInfo);
  //RegisterMCAsmInfoFn B(TheLE164elTarget, createLE1MCAsmInfo);
