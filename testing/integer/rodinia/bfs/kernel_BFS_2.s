...
mov.0 r0.3, group_id
;
sh2add.0 r0.57, r0.2, r0.3
ldw.0 r0.2, r0.1[0x8]
;
stw.0 r0.57[0x8], r0.2
stw.0 r0.1[0x4], r0.0
;
...
ldw.0 r0.2, r0.1[0x4]
;
stw.0 r0.57[0x4], r0.2
stw.0 r0.1[0x0], r0.0
;
goto.0 (temp_BFS_2_L0?5)
;
-- temp_BFS_2_L0?6
ldw.0 r0.2, r0.1[0x0]
;
stw.0 r0.57[0x0], r0.2
...
;
br.0 b0.0, (temp_BFS_2_L0?7)
;
goto.0 (temp_BFS_2_L0?6)
;
-- temp_BFS_2_L0?9
mov.0 r0.3, r0.0
ldw.0 r0.57, r0.1[0x10]
;
...
;
shru.0 r0.2, r0.2, 0x8
ldw.0 r0.10, r0.0[(num_cores+0)]
;
mpylu.0 r0.11, r0.2, r0.10
mpyhs.0 r0.10, r0.2, r0.10
;
...
;
shru.0 r0.2, r0.2, 0x8
ldw.0 r0.8, r0.0[(num_cores+0)]
;
mpylu.0 r0.9, r0.2, r0.8
mpyhs.0 r0.8, r0.2, r0.8
;
...
;
mpylu.0 r0.9, r0.8, r0.2
mpyhs.0 r0.2, r0.8, r0.2
;
