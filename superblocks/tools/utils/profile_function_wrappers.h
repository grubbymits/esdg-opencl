...
char * memprof_strchr(const char *s, int c);
char * memprof_strrchr(const char *s, int c);
...
char * memprof_strstr(const char *s1, const char *s2);
...
char * memprof_strpbrk(const char *s1, const char *s2);
